...
$existingOptions = $stmt->fetchAll();

foreach ($existingOptions as $option) {

    if (isset($options[$option['option_key']])) {

        $options[$option['option_key']] =
            $option['option_text'];
...
$isActive = (int) $questionData['is_active'];
    ...
    */
    ...
    if (in_array($questionType, $optionTypes, true)) {
        ...
        if (
            ...
            $errors[] =
                'At least options A and B are required.';
        ...
        if ($answer === '') {
            ...
            $errors[] =
                'Answer is required for this question type.';
